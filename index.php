...
<div class="container">
   ...
   <div class="flex">
      ...
      <a href="view.php" class="btn">View order</a>
...
?>
   <form method="post" class="box" action="">
      <img src="pic2.jpg" alt="productimg">
      <div class="name"><?php echo $fetch_product['name']; ?></div>
      <div class="price">$<?php echo $fetch_product['price']; ?>/-</div>
      <input type="number" min="1" name="product_quantity" value="1">
      <input type="hidden" name="product_image" value="pic2.jpg">
...
?>
   ...
   <div class="cart-btn">  
      <a href="order.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Next</a>
   </div>
   </div>
